...
@Mod(modid = NBTManipulator.MODID, name = NBTManipulator.NAME, version = NBTManipulator.VERSION, dependencies = "required-after:fantasticlib@[1.12.2.029b,)", acceptableRemoteVersions = "*")
public class NBTManipulator
{
    ...
    public static final String VERSION = "1.12.2.002f";
